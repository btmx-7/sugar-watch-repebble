...
const DemoScenario demo_scenarios[DEMO_SCENARIO_COUNT] = {
  /* name           gluc trend delta  age   wT  wI  HR   steps  layout slots         graph */
  { "urgent_low",   45,  6,    -15,   60,   10, 0,  88,  1234,  0,     {2,1,5,3},    2 },
  { "low",          65,  5,    -8,    120,  10, 0,  72,  3201,  0,     {2,1,5,3},    2 },
  { "in_range",     120, 3,     2,    180,  10, 0,  128, 6842,  0,     {2,1,5,3},    0 },
  { "high",         195, 1,     10,   120,  22, 0,  95,  8500,  0,     {2,1,5,3},    1 },
  { "urgent_high",  270, 0,     18,   60,   22, 0,  110, 12034, 0,     {2,1,5,3},    1 },
  { "stale",        120, 7,     0,    1800, 10, 0,  0,   0,     0,     {2,1,5,3},    3 },
  { "dashboard",    142, 3,     3,    180,  12, 0,  78,  6842,  1,     {2,1,5,0},    0 },
  { "zero_state",   0,   7,     0,    0,    -128,7, 0,   0,     0,     {0,0,0,0},    3 },
};
